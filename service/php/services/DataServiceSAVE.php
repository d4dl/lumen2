...
class DataService {
    ...
    private function __construct() {
        ...
        $this->FinancialAidApplication = $this->getCollection("FinancialAidApplication");
...
//        $applicationCursor = $this->AdmissionApplication->find($query, $limit);
    ...
    public function savePersonAndSwapForId(&$containingData, $dataMemberName, $dataMemberId) {
        //error_log("Saving sub document $dataMemberId $dataMemberName : " .json_encode($containingData) );
    ...
    public function savePerson($person) {
        ...
        error_log("Thisis hte person getting persissted " . json_encode($person));
