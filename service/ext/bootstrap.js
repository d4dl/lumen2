...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.ComponentRowExpander": "app.js",
  "Lumen": "app",
  "LumenClient.view.ClientApplication": "app/view/BaseApplication.js",
  "MyApp": "app",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Lumen.Application": [],
  "Lumen.controller.ExternalPartyController": [],
  "Lumen.controller.JsonPathFormController": [],
  "Lumen.controller.MainDisplayController": [],
  "Lumen.controller.PaymentPlanController": [],
  "Lumen.controller.UserStartup": [],
  ...
  "Lumen.model.AdmissionApplication": [],
  "Lumen.model.Applicant": [],
  "Lumen.model.DebitSchedule": [],
  "Lumen.model.DebitScheduleEntry": [],
  "Lumen.model.DebitScheduleTemplate": [],
  "Lumen.model.Fee": [],
  "Lumen.model.JSONForm": [],
  "Lumen.model.Person": [],
  "Lumen.model.Principal": [],
  "Lumen.store.AdmissionApplication": [],
  "Lumen.store.AdmissionApplicationList": [],
  "Lumen.store.Applicant": [],
  "Lumen.store.Authentication": [],
  "Lumen.store.CountryStore": [],
  "Lumen.store.DebitSchedule": [],
  "Lumen.store.DebitScheduleTemplate": [],
  "Lumen.store.GradeStore": [],
  "Lumen.store.JSONForm": [],
  "Lumen.store.Person": [],
  "Lumen.store.RestStore": [],
  "Lumen.store.StateStore": [],
  "Lumen.store.UIState": [],
  "Lumen.view.AccordionStretch": [],
  "Lumen.view.AdminDashboard": [],
  "Lumen.view.AdminMenu": [],
  "Lumen.view.AdmissionApplicationGrid": [],
  "Lumen.view.AdmissionApplicationMenu": [],
  "Lumen.view.AdmissionProcessMenu": [],
  "Lumen.view.BaseApplication": [],
  "Lumen.view.BaseForm": [],
  "Lumen.view.CenterLayout": [],
  "Lumen.view.Descriptions": [],
  "Lumen.view.EvaluationLoader": [],
  "Lumen.view.FamilyInfo": [],
  "Lumen.view.FileDropPlugin": [],
  "Lumen.view.JSONForm": [],
  "Lumen.view.JSONFormContainer": [],
  "Lumen.view.LoginPanel": [],
  "Lumen.view.Main": [],
  "Lumen.view.PersonGrid": [],
  "Lumen.view.PersonInfo": [],
  "Lumen.view.RemoveButton": [],
  "Lumen.view.StudentParentTree": [],
  "Lumen.view.UIContent": [],
  "Lumen.view.finance.DebitSchedule": [],
  "Lumen.view.finance.DebitScheduleEntry": [],
  "Lumen.view.finance.Fee": [],
  "Lumen.view.form.Address": [],
  "Lumen.view.form.BindableCheckboxGroup": [],
  "Lumen.view.form.BindableRadioGroup": [],
  "Lumen.view.form.CreditCardForm": [],
  "Lumen.view.form.DataFormFieldSet": [],
  "Lumen.view.form.EvaluationForm": [],
  "Lumen.view.form.FieldGroupMixin": [],
  "Lumen.view.form.FileUploadHTML5": [],
  "Lumen.view.form.FormLoader": [],
  "Lumen.view.form.ImageDrop": [],
  "Lumen.view.form.MultiAnswerQuestion": [],
  "Lumen.view.form.MultiAnswerQuestionGrid": [],
  "Lumen.view.form.MultipleChoice": [],
  "Lumen.view.form.MultipleChoiceQuestion": [],
  "Lumen.view.form.PaymentPlanForm": [],
  "Lumen.view.form.PersonName": [],
  "Lumen.view.form.PhoneNumber": [],
  "Lumen.view.form.ProductCheckBoxGroup": [],
  "Lumen.view.form.QuestionResponseFormFieldSet": [],
  "Lumen.view.form.RadioGroupContainer": [],
  "Lumen.view.form.ShortQuestion": [],
  "Lumen.view.form.Slider": [],
  "Lumen.view.form.SurveyQuestionGrid": [],
  "Lumen.view.form.TextAreaFieldSet": [],
  "Lumen.view.form.TuitionOptions": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Lumen.view.AdmissionProcessMenu": [
    "widget.admissionprocessmenu"
  ],
  "Lumen.view.BaseApplication": [
    "widget.baseapplication"
  ],
  "Lumen.view.BaseForm": [
    "widget.baseform"
  ],
  ...
  "Lumen.view.finance.DebitSchedule": [
    "widget.debitschedule"
  ],
  "Lumen.view.finance.DebitScheduleEntry": [
    "widget.debitscheduleentry"
  ],
  "Lumen.view.finance.Fee": [
    "widget.fee"
  ],
  ...
  "Lumen.view.form.BindableCheckboxGroup": [
    "widget.bindablecheckboxgroup"
  ],
  "Lumen.view.form.BindableRadioGroup": [
    "widget.bindableradiogroup"
  ],
  "Lumen.view.form.CreditCardForm": [
    "widget.creditcardform"
  ],
  "Lumen.view.form.DataFormFieldSet": [
    "widget.dataformfieldset"
  ],
  "Lumen.view.form.EvaluationForm": [
  ...
  "Lumen.view.form.FieldGroupMixin": [],
  "Lumen.view.form.FileUploadHTML5": [
    "widget.filefieldhtml5",
    "widget.fileuploadfieldhtml5"
  ],
  "Lumen.view.form.FormLoader": [
    "widget.appformloader"
  ],
  "Lumen.view.form.ImageDrop": [
    "widget.imagedrop"
  ],
  "Lumen.view.form.MultiAnswerQuestion": [
    "widget.multianswerquestion"
  ],
  "Lumen.view.form.MultiAnswerQuestionGrid": [
    "widget.multianswerquestiongrid"
  ],
  "Lumen.view.form.MultipleChoice": [],
  "Lumen.view.form.MultipleChoiceQuestion": [
  ...
  "Lumen.view.form.ProductCheckBoxGroup": [
    "widget.productcheckboxgroup"
  ],
  "Lumen.view.form.QuestionResponseFormFieldSet": [
    "widget.questionresponseformfieldset"
  ],
  "Lumen.view.form.RadioGroupContainer": [
    "widget.radiogroupcontainer"
  ],
  "Lumen.view.form.ShortQuestion": [
    "widget.shortquestion"
  ],
  "Lumen.view.form.Slider": [],
  "Lumen.view.form.SurveyQuestionGrid": [
    "widget.surveyquestiongrid"
  ],
  "Lumen.view.form.TextAreaFieldSet": [
    "widget.textareafieldset"
  ],
  "Lumen.view.form.TuitionOptions": [
    "widget.tuitionoptions"
  ],
  "Lumen.view.outputgenerators.Date": [],
  "Lumen.view.outputgenerators.HtmlOutputGenerator": [],
  "Lumen.view.outputgenerators.OutputGenerator": [],
...
Ext.setVersion("ext-theme-gray-9a90b101-9a31-48ac-a224-71414fd6507e", "1.0.0");
