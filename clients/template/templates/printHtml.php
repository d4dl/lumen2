<html><head><title>__TITLE__: __DATE__</title>
	...
	margin-top: 20px;"></a><a name="top"></a></td>
                ...
                <tr>
                    <td colspan="2" style="background-color: #000;background-repeat: repeat-x; border-left: 1px solid #0071BC; border-right: 1px solid #0071BC; height:38px;"><h2 style="color: #fff;margin: 5px 5px 5px 10px; font-size:13pt; font-weight:normal;">__TITLE__: __DATE__</h2></td>
                </tr>
                <tr>
